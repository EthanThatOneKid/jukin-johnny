...
var player = function() {
    ...
    this.update = function() {
        ...
        if (keyIsPressed && keyCode === DOWN_ARROW || keyCode === 83) {
            this.y += this.spd;
        }
        if (keyIsPressed && keyCode === LEFT_ARROW || keyCode === 65) {
            this.x -= this.spd;
        }
        if (keyIsPressed && keyCode === RIGHT_ARROW || keyCode === 68) {
            this.x += this.spd;
        }
	...
	this.vx = -(this.x - mouseX) / 30;
        this.vy = -(this.y - mouseY) / 30;
	this.x += this.vx;
	this.y += this.vy;
